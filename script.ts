...
async function main() {
  ...
  console.log(`Retrieved all published posts:`)
  ...
  console.log(`Published the newly created post:`)
  console.dir(updatedPost, { depth: Infinity })
  ...
  console.log(`Retrieved all posts from a specific user:`)
  console.dir(postsByUser, { depth: Infinity })
}
